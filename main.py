...
parser.add_argument('--CR', nargs=1, help='Contrast ratio for dataset to load (default "10")', choices=['10', '50'], default='10')
...
def main():
    ...
    print("Testing RMSE percent loss is {}".format(
        model.computePredictionLoss(test_predictions, y_test)))

    # compute MASE errors
    rel_errs = computeImgErr(test_predictions, y_test)
